    ...
    <div className="mx-auto max-w-7xl px-3 py-4 sm:px-4 sm:py-8">
      ...
      <div className="mt-4 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        <div className="mx-auto w-full max-w-[620px]">
          <div className="relative w-full aspect-[4/5] overflow-hidden rounded-2xl border border-slate-200 bg-[#f6f6f6]">
            <img
              src={mockups[side]}
              alt="Tshirt"
            ...
            <button
              ...
              className="absolute right-2 top-2 z-30 rounded-lg border border-slate-200 bg-white/95 px-2.5 py-2 text-xs font-semibold shadow-sm hover:bg-white sm:right-4 sm:top-4 sm:text-sm"
            >
              Flip
            </button>
        ...
        <aside className="h-fit rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
          <h3 className="text-lg font-bold text-slate-900">Design Controls</h3>
          <p className="mt-1 text-xs text-slate-500">Add text and images, then adjust the selected layer.</p>

          <div className="mt-4 grid grid-cols-1 gap-2">
            <button onClick={addText} className="h-10 rounded-lg border border-slate-200 text-sm font-semibold hover:bg-slate-50">
              Add Text
            </button>
            <button onClick={onUploadClick} className="h-10 rounded-lg border border-slate-200 text-sm font-semibold hover:bg-slate-50">
              Upload Image
            </button>
            <button onClick={() => setOpenGallery(true)} className="h-10 rounded-lg border border-slate-200 text-sm font-semibold hover:bg-slate-50">
              Open Gallery
            </button>
          </div>
          ...
          <div className="mt-4 space-y-2 border-t border-slate-100 pt-4">
            <button
              ...
              className="h-10 w-full rounded-lg border border-slate-200 text-sm font-semibold hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-300"
            >
              Edit Selected Text
            </button>
            <button
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                disabled={!activeItem}
                className="h-10 rounded-lg border border-slate-200 text-sm font-semibold hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-300"
              >
                Bring Front
              </button>
              <button
          ...
          <button
            onClick={onNext}
            className="mt-5 h-11 w-full rounded-lg bg-slate-900 text-sm font-bold text-white hover:bg-slate-800"
          >
            Continue to Preview
          </button>

          <p className="mt-3 text-[11px] text-slate-500">
            Tip: Arrow keys move | Shift + Arrow moves faster | Delete removes
          </p>
        </aside>
      </div>
